...
@router.callback_query(F.text(text='forward'))
...
# во время взаимодействия пользователя с сообщением-книгой
@router.callback_query(F.text(text='backward'))
...
@router.callback_query(F.text(text='edit_bookmarks'))
...
@router.callback_query(F.text(text='cancel'))
